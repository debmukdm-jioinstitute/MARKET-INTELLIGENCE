        ...
        <div className="mt-5 space-y-4 font-mono text-xs">
          ...
          <div className="rounded-xl border border-border/70 bg-card/50 p-3.5 space-y-2">
            <div className="flex items-baseline justify-between">
              ...
              <span className="font-bold text-base text-foreground">21.8x</span>
            </div>
            <div className="flex items-center justify-between text-muted-foreground text-[11px]">
              <span>5Y Historical Average</span>
              <span className="font-semibold text-foreground">20.4x</span>
            </div>
            <div className="flex items-center justify-between text-muted-foreground text-[11px]">
              <span>10Y Historical Average</span>
              <span className="font-semibold text-foreground">19.7x</span>
            </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="rounded-lg border border-border/70 bg-card/40 p-3">
              <span className="text-muted-foreground block text-[10px] uppercase">NIFTY P/B</span>
              <span className="font-bold text-foreground text-sm mt-0.5 block">3.1x</span>
            </div>
            <div className="rounded-lg border border-border/70 bg-card/40 p-3">
              <span className="text-muted-foreground block text-[10px] uppercase">Dividend Yield</span>
              <span className="font-bold text-foreground text-sm mt-0.5 block">1.2%</span>
            </div>
          </div>

          {/* Broad Market Multiples */}
          <div className="rounded-xl border border-border/70 bg-card/40 p-3.5 space-y-2">
            <div className="flex items-center justify-between text-[11px]">
              <span className="text-muted-foreground">NIFTY MIDCAP 100 P/E</span>
              <span className="font-bold text-amber-400">31.4x (Elevated)</span>
            </div>
            <div className="flex items-center justify-between text-[11px]">
              <span className="text-muted-foreground">NIFTY SMALLCAP 100 P/E</span>
              <span className="font-bold text-foreground">28.9x</span>
            </div>
          </div>
        </div>
      </div>
