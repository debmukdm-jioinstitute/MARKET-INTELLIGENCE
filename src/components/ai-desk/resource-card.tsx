    ...
    <div className="rounded-lg border border-border bg-card p-4">
      ...
      <div className="mt-3 flex flex-wrap gap-2">
        <a
          ...
          className="inline-flex items-center gap-1.5 rounded-md border border-border px-2.5 py-1 text-sm text-muted-foreground hover:border-primary hover:text-primary"
        >
