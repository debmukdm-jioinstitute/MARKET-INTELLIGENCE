...
import { SSE_STREAM_URL, type StreamPayload } from "@/lib/ai-trader/api";
import { playCoinChime, primeAudio, requestNotificationPermission, showTradeNotification } from "@/lib/ai-trader/tradeAlert";
...
export function AlgoProviders({ children }: { children: React.ReactNode }) {
  return (
    <TradingModeProvider>
      <GlobalTradeAlert />
      <GlobalShortcuts>
