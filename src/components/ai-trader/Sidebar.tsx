...
const nav = [
  { href: "/algo", label: "Dashboard", icon: LayoutDashboard },
...
function navActive(pathname: string, href: string) {
  if (href === "/algo") return pathname === "/algo";
  ...
  return (
    <aside className="w-52 min-h-screen flex flex-col" style={{ background: '#0e1117', borderRight: '1px solid #252a33' }}>
      ...
      <div className="px-4 py-4" style={{ borderBottom: '1px solid #252a33' }}>
        ...
        <p className="text-[9px] mt-1 tracking-widest" style={{ color: "#3d4450" }}>
          NIFTY F&amp;O · AI-trader engine
        </p>
      </div>
