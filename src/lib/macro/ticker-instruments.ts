...
export const TICKER_INSTRUMENTS: TickerInstrument[] = [
  ...
  { id: "midcap", label: "NIFTY MIDCAP", symbol: "^CNXMID", copyKey: "ticker_midcap", group: "india" },
  { id: "smallcap", label: "NIFTY SMALLCAP", symbol: "^CNXSMALLCAP", copyKey: "ticker_smallcap", group: "india" },
