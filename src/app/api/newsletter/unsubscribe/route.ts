...
function page(title: string, message: string) {
  return new NextResponse(
    ...
    <style>body{font-family:system-ui,sans-serif;background:#fff;color:#1f1f1f;display:flex;min-height:100vh;align-items:center;justify-content:center;margin:0}
